...
'''
# -----------------------------------------------------------------------------
# g2-sdk-python-next.py Example python skeleton.
...
def get_parser():
    ...
    parser = argparse.ArgumentParser(prog="g2-sdk-python-next.py", description="Add description. For more information, see https://github.com/Senzing/g2-sdk-python-next")
