...
class SzException(Exception):
    """Base exception for Senzing related python code."""
...
class SzBadInputError(SzException):
    """The user-supplied input contained an error."""


class SzConfigurationError(SzException):
    """The program can provide a remedy and continue."""


class SzRetryableError(SzException):
    """The program can provide a remedy and continue."""


class SzUnrecoverableError(SzException):
...
EXCEPTION_MAP = {
    ...
    5:     SzException,                    # EAS_ERR_EXCEEDED_MAX_RETRIES                                                           "Exceeded the Maximum Number of Retries Allowed"
    ...
    29:    SzException,                    # EAS_ERR_INVALID_HANDLE                                                                 "Invalid Handle"
    ...
    38:    SzException,                    # EAS_ERR_RECORD_HAS_NO_RESOLVED_ENTITY                                                  "Data source record has no resolved entity: dsrc[{0}], recordID[{1}]"
    39:    SzException,                    # EAS_ERR_NO_OBSERVED_ENTITY_FOR_DSRC_ENTITY_KEY                                         "No observed entity for entity key: dsrc[{0}], record_id[{1}], key[{2}]"
    ...
    41:    SzException,                    # EAS_ERR_DOCUMENT_PREPROCESSING_FAILED                                                  "Document preprocessing failed"
    42:    SzException,                    # EAS_ERR_DOCUMENT_LOAD_PROCESSING_FAILED                                                "Document load processing failed"
    43:    SzException,                    # EAS_ERR_DOCUMENT_ER_PROCESSING_FAILED                                                  "Document ER processing failed"
    44:    SzException,                    # EAS_ERR_CHECK_ENTITY_PROCESSING_FAILED                                                 "Check entity processing failed"
    45:    SzException,                    # EAS_ERR_UMF_PROC_PROCESSING_FAILED                                                     "UMF procedure processing failed"
    46:    SzException,                    # EAS_ERR_DOCUMENT_HASHING_PROCESSING_FAILED                                             "Document hashing-processing failed"
    47:    SzException,                    # EAS_ERR_SESSION_IS_INVALID                                                             "Session is invalid"
    ...
    52:    SzException,                    # EAS_ERR_UNKNOWN_RELATIONSHIP_ID_VALUE                                                  "Unknown relationship ID value '{0}'"
    ...
    55:    SzException,                    # EAS_ERR_NO_RESOLVED_ENTITY_FOR_DSRC_ENTITY_KEY                                         "No resolved entity for entity key: dsrc[{0}], record_id[{1}], key[{2}]"
    56:    SzException,                    # EAS_ERR_NO_RECORDS_EXIST_FOR_RESOLVED_ENTITY                                           "No data source records exist for entity ID: entityID[{0}]"
    57:    SzException,                    # EAS_ERR_UNKNOWN_FEATURE_ID_VALUE                                                       "Unknown feature ID value '{0}'"
    58:    SzException,                    # EAS_ERR_G2_INITIALIZATION_FAILURE                                                      "G2 initialization process has failed"
    ...
    68:    SzException,                    # EAS_ERR_UNKNOWN_ER_RESULT                                                              "Unknown ER-result."
    69:    SzException,                    # EAS_ERR_NO_CANDIDATES                                                                  "No candidates."
    76:    SzException,                    # EAS_ERR_INBOUND_FEATURE_VERSION_NEWER_THAN_CONFIG                                      "Inbound Feature Version [{0}] is newer than configured version [{1}] for feature type[{2}]."
    77:    SzException,                    # EAS_ERR_ERROR_WHEN_PRIMING_GNR                                                         "Error when priming GNR resources '{0}'"
    78:    SzException,                    # EAS_ERR_ERROR_WHEN_ENCRYPTING                                                          "Error when encrypting '{0}'"
    79:    SzException,                    # EAS_ERR_ERROR_WHEN_DECRYPTING                                                          "Error when decryting '{0}'"
    80:    SzException,                    # EAS_ERR_ERROR_WHEN_VALIDATING_ENCRYPTION_SIGNATURE_COMPATIBILITY                       "Error when validating encryption signature compatibility '{0}'"
    81:    SzException,                    # EAS_ERR_ERROR_WHEN_CHECKING_DISTINCT_FEATURE_GENERALIZATION                            "Error when checking distinct feature generalization '{0}'"
    82:    SzException,                    # EAS_ERR_ERROR_WHEN_RUNNING_DQM                                                         "Error when running DQM '{0}'"
    83:    SzException,                    # EAS_ERR_ERROR_WHEN_CREATING_EFEATS                                                     "Error when creating EFEATS '{0}'"
    84:    SzException,                    # EAS_ERR_ERROR_WHEN_SIMPLE_SCORING                                                      "Error when simple scoring '{0}'"
    85:    SzException,                    # EAS_ERR_ERROR_WHEN_SCORING_PAIR                                                        "Error when scoring a pair '{0}'"
    86:    SzException,                    # EAS_ERR_ERROR_WHEN_SCORING_SET                                                         "Error when scoring a set '{0}'"
    ...
    2002:  SzException,                    # EAS_ERR_REQUESTED_CONFIG_FOR_INVALID_FTYPE_CODE                                        "Requested config for invalid FTYPE_CODE[{0}]"
    2003:  SzException,                    # EAS_ERR_NO_FELEM_CODE                                                                  "Cannot process OBS_FELEM with no FELEM_CODE[{0}]"
    2005:  SzException,                    # EAS_ERR_INVALID_FELEM_CODE                                                             "FELEM_CODE[{0}] is not configured for FTYPE_CODE[{1}]"
    2006:  SzException,                    # EAS_ERR_MISSING_ENT_SRC_KEY                                                            "OBS_ENT is missing ENT_SRC_KEY"
    2007:  SzException,                    # EAS_ERR_MISSING_OBS_SRC_KEY                                                            "OBS is missing OBS_SRC_KEY"
    ...
    2027:  SzException,                    # EAS_ERR_PLUGIN_INIT                                                                    "Plugin initialization error {0}"
    ...
    2073:  SzException,                    # EAS_ERR_LOADING_LIBRARY                                                                "Library loading error {0}"
    2074:  SzException,                    # EAS_ERR_SCORING_MANAGER_PLUGIN                                                         "Scoring manager: id {0} and {1} do not match"
    ...
    2116:  SzException,                    # EAS_ERR_UNITIALIZED_AMBIGUOUS_CACHE                                                    "Uninitialized Ambiguous Test Cache"
    ...
    2221:  SzConfigurationError,           # EAS_ERR_FUNCTION_USES_BOTH_FTYPE_AND_FELEM_TRIGGER                                     "Function call requested uses both triggering feature type [{0}] and triggering feature element code [{1}].  Cannot use both triggering feature type and triggering feature element cod
    ...
    2285:  SzException,                    # EAS_ERR_INVALID_FORMAT_FOR_ENTITIES                                                    "Invalid format for ENTITIES."
    2286:  SzException,                    # EAS_ERR_NO_ENTITY_ID_FOUND_FOR_ENTITY                                                  "No entity ID found for entity."
    2287:  SzException,                    # EAS_ERR_NO_DATA_SOURCE_FOUND                                                           "No data source found."
    2288:  SzException,                    # EAS_ERR_NO_RECORD_ID_FOUND                                                             "No record ID found."
    ...
    2292:  SzException,                    # EAS_ERR_CANT_RETRIEVE_OBS_FEATURE_DATA_FOR_OBS_ENT                                     "Could not retrieve observed feature data for observed entity [{0}]."
    2293:  SzException,                    # EAS_ERR_NO_RECORDS_SPECIFIED                                                           "No records specified."
    2294:  SzException,                    # EAS_ERR_DATA_SOURCE_ID_DOES_NOT_EXIST                                                  "Data source ID [{0}] does not exist."
    2295:  SzException,                    # EAS_ERR_ETYPE_CODE_DOES_NOT_EXIST                                                      "Entity type code [{0}] does not exist."
    ...
    7222:  SzException,                    # EAS_ERR_FAILED_TO_SET_SYS_VAR_IN_DATASTORE                                             "Could not set system variable value in database for Group[{0}],Code[{1}],Value[{2}]."
    ...
    7511:  SzException,                    # EAS_ERR_ABORT_ER_AND_RETRY                                                             "Detected change in candidate entity[{0}].  Restarting ER evaluation."
    8000:  SzBadInputError,                # EAS_ERR_GNRNP                                                                          "GNR NameParser Failure"
    8410:  SzException,                    # EAS_ERR_UNINITIALIZED_AMBIGUOUS_FEATURE                                                "Cannot use uninitialized ambiguous feature."
    8501:  SzConfigurationError,           # EAS_ERR_SALT_DIGEST_ALGORITHM_NOT_AVAILABLE                                            "Failed to get {0} digest algorithm from ICC."
    8502:  SzException,                    # EAS_ERR_SALT_DIGEST_CONTEXT_CREATE_FAILED                                              "Failed to create a digest context."
    8503:  SzException,                    # EAS_ERR_SALT_DIGEST_CONTEXT_INIT_FAILED                                                "Failed {0} to initialise a digest context."
    8504:  SzException,                    # EAS_ERR_SALT_DIGEST_FAILED                                                             "Failed {0} to digest block {1}."
    8505:  SzException,                    # EAS_ERR_SALT_DIGEST_FINAL_FAILED                                                       "Failed {0} to complete digest."
    8508:  SzException,                    # EAS_ERR_SALT_DIGEST_UNKNOWN_EXCEPTION                                                  "Unrecognized exception thrown generating digest."
    8509:  SzException,                    # EAS_ERR_SALT_DIGEST_ALGORITHM_REQUIRED                                                 "Cannot generate a digest without a valid algorithm."
    8514:  SzException,                    # EAS_ERR_SALT_RANDOM_FAILED                                                             "Failed {0} to get random content"
    ...
    8520:  SzException,                    # EAS_ERR_SALT_G2SS_INIT_FAILED                                                          "Secure Store initialization failed."
    8521:  SzException,                    # EAS_ERR_SALT_G2SS_TOKEN_MUST_BE_INIT                                                   "Hashing with a named salt requires the Secure Store to be initialised."
    8522:  SzConfigurationError,           # EAS_ERR_SALT_G2SS_SOPIN_NOT_VALID                                                      "The Security Officer (SO) PIN is not correct."
    8524:  SzException,                    # EAS_ERR_SALT_G2SS_INIT_UNKNOWN_EXCEPTION                                               "Secure Store initialization failed with an unrecognised exception"
    ...
    8530:  SzException,                    # EAS_ERR_SALT_CANNOT_OVERWRITE                                                          "You cannot overwrite an existing salt called {0}"
    ...
    8539:  SzException,                    # EAS_ERR_SALT_G2SS_ERROR_CHANGING_METHOD                                                "Secure Store error changing hashing method"
    8540:  SzConfigurationError,           # EAS_ERR_SALT_WRONG_SIZE                                                                "The object called {0} is not a salt"
    8541:  SzException,                    # EAS_ERR_SALT_BASE64_DECODE_ERROR                                                       "Base64 decoding error in salt {0} at character {1}"
    8542:  SzException,                    # EAS_ERR_SALT_UNINITIALISED                                                             "Must load a salt before using it."
    ...
    8593:  SzException,                    # EAS_ERR_SALT_HMAC_CONTEXT_INIT_FAILED                                                  "Failed {0} to initialise an HMAC context."
    8594:  SzException,                    # EAS_ERR_SALT_HMAC_FAILED                                                               "Failed {0} to HMAC block {1}."
    8595:  SzException,                    # EAS_ERR_SALT_HMAC_FINAL_FAILED                                                         "Failed {0} to complete HMAC."
    8598:  SzException,                    # EAS_ERR_SALT_HMAC_UNKNOWN_EXCEPTION                                                    "Unrecognized exception thrown generating HMAC."
    ...
    8603:  SzException,                    # EAS_ERR_HASHER_UNABLE_TO_RECORD_SALT                                                   "Unable to record the configured salt"
    ...
    8607:  SzConfigurationError,           # EAS_ERR_HASHER_INVALID_ARGS                                                            "Invalid arguments to hashing function. Either a parameter wasn't provided or a buffer was too small: location={0}, dataPtr={1}, dataLength={2}, outputPtr={3}, outputLength={4}, outpu
    ...
    9267:  SzException,                    # EAS_ERR_G2SS_UNABLE_TO_CREATE_KEY                                                      "Secure Store key creation failed."
    9268:  SzException,                    # EAS_ERR_G2SS_UNABLE_TO_CHANGE_PIN                                                      "Secure Store password change failed: {0}."
    ...
    9271:  SzException,                    # EAS_ERR_G2SS_OUT_OF_MEMORY                                                             "Secure Store out of memory."
    9272:  SzException,                    # EAS_ERR_G2SS_FIND_INIT_FAILED                                                          "Secure Store object locating failed: {0}."
    9273:  SzException,                    # EAS_ERR_G2SS_FIND_FAILED                                                               "Secure Store object find failed: {0}."
    9274:  SzException,                    # EAS_ERR_G2SS_CRYPTO_SETUP_FAILED                                                       "Secure Store setup of encryption failed: {0}."
    9275:  SzException,                    # EAS_ERR_G2SS_ENCRYPT_START_FAILED                                                      "Secure Store unable to start encryption: {0}."
    9276:  SzException,                    # EAS_ERR_G2SS_ENCRYPT_SIZE_FAILED                                                       "Secure Store unable to get the size of encrypted data: {0}."
    9277:  SzException,                    # EAS_ERR_G2SS_ENCRYPT_FAILED                                                            "Secure Store encryption failed: {0}."
    9278:  SzException,                    # EAS_ERR_G2SS_DECRYPT_START_FAILED                                                      "Secure Store unable to start decryption: {0}."
    9279:  SzException,                    # EAS_ERR_G2SS_DECRYPT_FAILED                                                            "Secure Store decryption failed: {0}."
    9280:  SzException,                    # EAS_ERR_G2SS_OBJECT_SAVE_FAILED                                                        "Secure Store unable to save object: {0}."
    9281:  SzException,                    # EAS_ERR_G2SS_OBJECT_DELETE_FAILED                                                      "Secure Store unable to delete object: {0}."
    9282:  SzException,                    # EAS_ERR_G2SS_OBJECT_CHANGE_FAILED                                                      "Secure Store unable to modify object: {0}."
    9283:  SzException,                    # EAS_ERR_G2SS_UNINITIALISED                                                             "Secure Store has not been initialized"
    9284:  SzException,                    # EAS_ERR_G2SS_INVALID_SLOT_ID                                                           "Can not obtain info on specified slot. Possibly invalid slot ID specified in Secure Store URL: {0}"
    ...
    9287:  SzException,                    # EAS_ERR_G2SS_TOKEN_IMPL_ERROR                                                          "An internal error occurred in the security token implementation library: Return Code = {0}"
    9288:  SzException,                    # EAS_ERR_G2SS_USER_PIN_PROMPT_FAILED                                                    "Was unable to prompt user for security token authentication."
    9289:  SzException,                    # EAS_ERR_G2SS_LABEL_CHANGED_SINCE_CONFIG_INIT                                           "Secure Store has been reconfigured since loading."
    9290:  SzException,                    # EAS_ERR_G2SS_OBJECT_NOT_FOUND                                                          "Secure Store does not have an object called {0}."
    ...
    9299:  SzException,                    # EAS_ERR_G2SS_CLASS_NOT_INIT                                                            "Secure Store internal error."
    ...
    9305:  SzException,                    # EAS_ERR_SEQUENCE_RETRIES_FAILED                                                        "Retries failed to retrieve Sequence Entry[{0}] in the SYS_SEQUENCE table!  This may mean the CACHE_SIZE is too small."
    ...
    9311:  SzException,                    # EAS_ERR_COULD_NOT_RECORD_USAGE_TYPE                                                    "Could not record usage type [{0}] in the LIB_UTYPE table!"
    9406:  SzException,                    # EAS_ERR_G2SS_SESSION_MUST_NOT_BE_OPEN                                                  "Secure Store cannot fetch a value with sync if a session is already open."
    ...
    9410:  SzException,                    # EAS_ERR_G2SS_PKCS_INIT_FAILED                                                          "Initializing token driver failed {0}"
    9411:  SzException,                    # EAS_ERR_G2SS_PKCS_FINAL_FAILED                                                         "Finalizing token driver failed {0}"
    ...
    9701:  SzException,                    # EAS_ERR_CANT_RETRIEVE_INDEX_FROM_MEMORY_ROW                                            "Cannot retrieve index[{0}] from memory row of key[{1}], out of range!"
    9703:  SzException,                    # EAS_ERR_MEMTBL_COL_INDEX_TOO_BIG                                                       "Current field in memory row is passed end of row"
    ...
    30011: SzException,                    # EAS_ERR_DELETE_WITH_RESOLVE_ONLY                                                       "Cannot delete an entity with type RESOLVE_ONLY"
    30101: SzException,                    # EAS_ERR_INVALID_SESSION_HANDLE                                                         "Invalid Session Handle [{0}]"
    30102: SzException,                    # EAS_ERR_INVALID_REPORT_HANDLE                                                          "Invalid Report Handle [{0}]"
    30103: SzException,                    # EAS_ERR_INVALID_EXPORT_HANDLE                                                          "Invalid Export Handle [{0}]"
    30110: SzException,                    # EAS_ERR_RESPONSE_MESSAGE_SIZE_LARGER_THAN_BUFFER_SIZE                                  "Response message size [{0}] is larger than buffer size [{1}]"
    30111: SzException,                    # EAS_ERR_RESPONSE_RESIZE_FUNCTION_IS_NOT_PROVIDED                                       "Resize function is not provided"
    30112: SzException,                    # EAS_ERR_RESPONSE_RESIZE_FUNCTION_GAVE_INVALID_RESULT                                   "Resize function returned an invalid result"
...
def new_szexception(
    ...
    *args: Any,
    ...
    senzing_error_class = EXCEPTION_MAP.get(senzing_error_code, SzException)
