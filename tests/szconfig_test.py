...
from senzing import SzConfigCore, SzConfigurationError
...
def test_constructor(engine_vars: Dict[Any, Any]) -> None:
    ...
    assert isinstance(actual, SzConfigCore)
...
def test_add_data_source(sz_config: SzConfigCore) -> None:
...
def test_add_data_source_bad_config_handle_type(sz_config: SzConfigCore) -> None:
    """Test SzConfig().add_data_source()."""
...
def test_close_config_bad_config_handle_type(sz_config: SzConfigCore) -> None:
...
def test_create_config(sz_config: SzConfigCore) -> None:
    """Test SzConfig().create()."""
    config_handle = sz_config.create_config()
...
def test_delete_data_source(sz_config: SzConfigCore) -> None:
...
def test_delete_data_source_bad_config_handle_type(sz_config: SzConfigCore) -> None:
    """Test SzConfig().delete_data_source()."""
    data_source_code = "TEST"
    bad_config_handle = "string"
    with pytest.raises(TypeError):
...
def test_get_data_sources(sz_config: SzConfigCore) -> None:
...
def test_get_data_sources_bad_config_handle_type(sz_config: SzConfigCore) -> None:
...
def test_import_config(sz_config: SzConfigCore) -> None:
...
def test_import_config_bad_config_definition_type(sz_config: SzConfigCore) -> None:
    """Test SzConfig().import_config()."""
...
def test_import_config_bad_config_definition_value(sz_config: SzConfigCore) -> None:
    """Test SzConfig().import_config()."""
...
def test_export_config(sz_config: SzConfigCore) -> None:
...
def test_export_config_bad_config_handle_type(sz_config: SzConfigCore) -> None:
    """Test SzConfig().export_config()."""
    bad_config_handle = "string"
    with pytest.raises(TypeError):
