...
def engine_vars():
    ...
    windows_json = r'{"PIPELINE":{"CONFIGPATH":"C:\Program Files\Senzing\g2","RESOURCEPATH":"C:\Program Files\Senzing\g2\resources","SUPPORTPATH":"C:\Program Files\Senzing\g2\data"},"SQL":{"CONNECTION":"sqlite3://na:na@C:\Temp\sqlite\G2C.db"}}'
